  ...
  return (
    <>
      <div>
        ...
        <p className="ml-2 mt-1 text-xs font-light text-gray-500 dark:text-gray-500">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            height="1em"
          ...
          starting and ending date and time as well as the candidates. And you
          can only set these values after creating the Election.
        </p>
      </div>
    </>
  );
