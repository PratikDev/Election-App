...
const svgClasses = `flex-shrink-0
  w-5
  h-5
  text-gray-500
  dark:text-gray-400
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-8 h-screen">
            ...
            <ul className="font-medium">
              {menuLinks.map(({ name, href, icon }, index) => (
                <li key={index} className="pb-2">
                  <Link href={href} className={MenuItemClasses}>
                    {icon}
        ...
        <main className="col-start-2 col-span-7 overflow-auto mt-14 p-4">
          {children}
        </main>
      </div>
    </>
